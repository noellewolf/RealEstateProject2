...
// GET BY....
	public Optional<Property> getPropertyBySize(String size) {
		return propertyRepository.findById(size);
	}
	public Optional<Property> getPropertyByCity(String city) {
		return propertyRepository.findById(city);
	}
	public Optional<Property> getPropertyByState(String state) {
		return propertyRepository.findById(state);
	}
	public Optional<Property> getPropertyByPrice(String price) {
		return propertyRepository.findById(price);
	}
	
//	public void propertyDiscount(Property property) {
//		Optional<Property> found = propertyRepository.findById(property.getDaysListed());
//		if(found.isPresent() ) {
//			Property edit = new Property();
//			edit.setSalePrice(Property.getSalePrice());
//			Property p1 = new Property(((Property) property.getProperty()).getSalePrice());
//			edit.setProperty(p1);
//			propertyRepository.deleteById(found.get().getDaysListed());
//			propertyRepository.save(edit);
//		}
//}
}
